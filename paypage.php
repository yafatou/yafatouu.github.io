    ...
    <div class="payment">
        <form>
            ...
            <div class="form-group Amount">
                ...
                <input type="text" amount class="form-control" id="amount">
            </div>
            <div class="form-group" id="expiration-date">
                <label>Expiration Date</label>
                <select class="option" name="month">
            ...
            <div class="form-group" id="pay-now">
                <button type="submit" class="btn btn-default" id="confirm-purchase"> <a href = "fin.html">Confirm </a></button>
            </div>
        </form>
    </div>
</div>
